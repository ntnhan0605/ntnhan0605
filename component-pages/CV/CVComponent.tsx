...
export type CVComponentProps = {
  infos?: Record<string, ReactNode>;
};
export const CVComponent: FC<CVComponentProps> = () => {
  return (
              ...
              <tr>
                <td colSpan={2}>
                  <p className={styles.note}>
                    ...
                    campaign has one website for each project. After the campaign ends, the site is
                    no longer kept. So I cannot save all the domains for that project.
                  </p>
                </td>
              </tr>
            </tbody>
