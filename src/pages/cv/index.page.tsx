        ...
        <ProfileBox borderRadius={1}>
          ...
          <ProfileBoxItem>
            ...
            <ProfileList>
              ...
              <li>
                In the long term, I want to be trained as a senior programmer
                for 4 years.
              </li>
            </ProfileList>
          </ProfileBoxItem>
            ...
            <ProfileBoxInnerItem>
              <Grid spacing={5} container>
                ...
                <Grid xs={7} item>
                  ...
                  <ProfileDescription>
                    My position:{' '}
                    <ProfileStrong>Software Engineer</ProfileStrong>
                    <br />
          ...
          <ProfileBoxItem>
            ...
            <ProfileBoxInnerItem>
              ...
              <ProfileList>
                <li>
                  Web App: Next JS, React JS, SCSS/SASS, CSS-in-JS, HTML, CSS,
                  JS
                </li>
                ...
                <ProfileBoxInnerItem>
                  <ProfileProjectTable className="half">
                    <tbody>
                      ...
                      <tr>
                        <td>Health tools, BMI/BMR tools, Lead tools</td>
                        <td>
                          <ProfileList>
                            <li>Library/Framework: ReactJS, NextJS</li>
                            <li>
                              Format: Typescript, ESLint, Prettier, NextJS
                            </li>
                            <li>JSX, styled-component</li>
                          </ProfileList>
                          <Typography fontStyle="italic">
                            Build component form & result for each market
                            <br />
                            Maintainece other tools
                          </Typography>
                        </td>
                      </tr>
                      <tr>
                        <td>Chat bot/Risk screener</td>
                        <td>
                          <ProfileList>
                            <li>
                            ...
                            <li>Format: Typescript, ESLint, Prettier</li>
                            <li>Others: Docker</li>
                          </ProfileList>
                          <Typography fontStyle="italic">
                      ...
                      <tr>
                        ...
                        <td>
                          <ProfileList>
                            ...
                            <li>Format: Typescript, ESLint, Prettier</li>
                            <li>Others: Redis, Docker, Ory Hydra</li>
                          </ProfileList>
                          <Typography fontStyle="italic">
                      ...
                      <tr>
                        ...
                        <td>
                          <ProfileList>
                            <li>
                              Library/Framework: ReactJS, NextJS, Ant Design,
                              React Flow, Recharts, Highcharts
                            </li>
                            <li>Format: Typescript, ESLint, Prettier</li>
                            <li>Others: Docker</li>
                          </ProfileList>
                      ...
                      <tr>
                        <td colSpan={2}>
                          <Typography fontStyle="italic">
                            ...
                            each project. After the campaign ends, the site is
                            no longer kept. So I cannot save all the domains for
                            that project.
                          </Typography>
                        </td>
                      </tr>
