...
const infos: Record<string, React.ReactNode> = {
  ...
  Address:
    '629 Kinh Duong Vuong, An Lac Ward, Binh Tan District, Ho Chi Minh City'
}
...
> = {
  'May 2021 – Now': {
    ...
    list: ['Developing web app', 'Maintain others web app']
  },
  'Mar 2021 – Apr 2021': {
...
const projectsInHHG: Project[] = [
  ...
  {
    name: 'Admin Data Analytics',
    size: '7',
    technology: [
      'Library/Framework: ReactJS, NextJS, Ant Design, React Flow, Recharts, Highcharts',
      'Format: Typescript, ESLint, Prettier',
      'Others: Docker'
    ],
    description: (
...
const projectsInCorsivaLab: Project[] = [
  {
    ...
    technology: [
      'HTML, CSS, jQuery',
      'Worpress: make theme from Front-end',
      'Woocommerce Plugin'
    ],
    description:
      'Flexible builder content on each layout with TypeRocket Plugin'
  },
  {
    name: (
      <>
    ...
    <div className={clsx('container-lg', styles.cv)}>
      ...
      <div className={clsx(styles.container, styles.projects)}>
        ...
        <div className={styles.project}>
          <h4 className={clsx(styles.subtitle, styles.note)}>
              ...
              <tr>
                <td colSpan={2}>
                  <p className={styles.note}>
                    ...
                    After the campaign ends, the site is no longer kept. So I
                    cannot save all the domains for that project.
                  </p>
                </td>
              </tr>
            </tbody>
