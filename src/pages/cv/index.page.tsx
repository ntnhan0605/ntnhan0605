                    ...
                    <tr>
                      ...
                      <td>
                        <ProfileList>
                          ...
                          <li>Format: Typescript, ESLint, Prettier, NextJS</li>
...
Resume.getLayout = (page: ReactNode) => {
  return (
    <ThemeProvider theme={themeValue}>
      <Head>
        <title>CV - Nguyen Thien Nhan - Front-end Developer</title>
      </Head>
      <GlobalStyles styles={globalStylesValue} />
      <CssBaseline enableColorScheme>{page}</CssBaseline>
    </ThemeProvider>
  )
}
